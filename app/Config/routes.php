 ...
 */
    ...
    Router::connect('/updateprofile/*', array('controller' => 'users', 'action' => 'updateprofile'));
    Router::connect('/logout/*', array('controller' => 'users', 'action' => 'logout'));
    Router::connect('/updateprofile/logout/*', array('controller' => 'users', 'action' => 'logout'));
    Router::connect('/updateprofile/id/*', array('controller' => 'users', 'action' => 'updateprofile'));
